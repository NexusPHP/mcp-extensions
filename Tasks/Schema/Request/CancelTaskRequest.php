 ...
 *
 * @extends JsonRpcRequest<'tasks/cancel', array{
 *   jsonrpc: '2.0',
 *   id: int|non-empty-string,
 *   method: 'tasks/cancel',
 *   params: template-type<CancelTaskRequestParams, RequestParams, 'T'>,
 * }>
 *
 * @see https://github.com/modelcontextprotocol/modelcontextprotocol/blob/main/seps/2663-tasks-extension.md
 */
final readonly class CancelTaskRequest extends JsonRpcRequest implements ClientRequest
{
    ...
    public static function fromArray(array $data): static
    {
        ...
        return new self(
            ...
            params: CancelTaskRequestParams::fromArray($data['params']),
        );
    }
