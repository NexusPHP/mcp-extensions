 ...
 *
 * @extends JsonRpcRequest<'tasks/update', array{
 *   jsonrpc: '2.0',
 *   id: int|non-empty-string,
 *   method: 'tasks/update',
 *   params: template-type<UpdateTaskRequestParams, RequestParams, 'T'>,
 * }>
 *
 * @see https://github.com/modelcontextprotocol/modelcontextprotocol/blob/main/seps/2663-tasks-extension.md
 */
final readonly class UpdateTaskRequest extends JsonRpcRequest implements ClientRequest
{
    public function __construct(RequestId $id, UpdateTaskRequestParams $params)
    {
    ...
    public static function fromArray(array $data): static
    {
        ...
        return new self(
            ...
            params: UpdateTaskRequestParams::fromArray($data['params']),
        );
    }
